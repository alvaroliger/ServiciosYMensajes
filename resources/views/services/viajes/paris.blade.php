...
>
    ...
    <!-- Contenedor del contenido (fondo blanco en modo claro y gris oscuro en modo oscuro) -->
    <div class="max-w-4xl mx-auto mt-12 mb-12 bg-white dark:bg-gray-800 shadow-2xl rounded-2xl p-8 transition-colors duration-300">
        ...
        <div x-data="{ current: 1 }" class="max-w-3xl mx-auto mb-10 space-y-4">
            ...
            <div class="flex justify-between">
                <button @click="current = (current === 1) ? 5 : (current - 1)"
                    class="bg-blue-600 hover:bg-blue-700 text-black dark:text-white px-4 py-2 rounded-md transition">
                    Anterior
                </button>
        ...
        <div class="mt-10">
            ...
            @auth
                <form method="POST" action="{{ route('services.comentar', $service->id) }}" class="space-y-4">
                    ...
                    <button type="submit"
                        class="bg-blue-600 hover:bg-blue-700 text-black dark:text-white px-5 py-2 rounded-lg shadow transition">
                        Publicar
                    </button>
                </form>
            @else
